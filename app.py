...
app.config['MAIL_USERNAME'] = os.environ.get('MAIL_USERNAME', 'buydirect24info@gmail.com')
app.config['MAIL_PASSWORD'] = os.environ.get('MAIL_PASSWORD', 'akex qbyg ftsj rget')
app.config['MAIL_DEFAULT_SENDER'] = os.environ.get('MAIL_DEFAULT_SENDER', 'buydirect24info@gmail.com')
mysql = MySQL(app)
mail = Mail(app)
bcrypt = Bcrypt(app)
